<?php use_helper('Date') ?>
<h1>Categorías de contenido web</h1>
<div id="buscador">
...
<table class="listado contenido">
  ...
  <tbody>
    ...
    <?php foreach ($categoria_contenidos as $categoria_contenido): ?>
      ...
      <td class="accionListado"><a class="ver" id="<?php echo $categoria_contenido->id ?>" href="javascript:void()"><img  title="Vista previa" alt="Vista previa" src="/images/iconos/vistaPrevia.png"></img></a></td>
