...
/**
 * ProgramaColegio filter form base class.
 *
 * @package    amina
 * @subpackage filter
 ...
 */
abstract class BaseProgramaColegioFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('programa_colegio_filters[%s]');
