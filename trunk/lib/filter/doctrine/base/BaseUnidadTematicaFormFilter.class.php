...
/**
 * UnidadTematica filter form base class.
 *
 * @package    amina
 * @subpackage filter
 ...
 */
abstract class BaseUnidadTematicaFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('unidad_tematica_filters[%s]');
