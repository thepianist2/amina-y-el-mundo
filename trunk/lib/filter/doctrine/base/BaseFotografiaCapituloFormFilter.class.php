...
/**
 * FotografiaCapitulo filter form base class.
 *
 * @package    amina
 * @subpackage filter
 ...
 */
abstract class BaseFotografiaCapituloFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      'idCapitulo'        => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('Capitulo'), 'add_empty' => true)),
    ...
    $this->setValidators(array(
      'idCapitulo'        => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('Capitulo'), 'column' => 'id')),
    ...
    $this->widgetSchema->setNameFormat('fotografia_capitulo_filters[%s]');
