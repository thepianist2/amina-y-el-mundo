...
/**
 * ProgramaColegio form base class.
 *
 * @method ProgramaColegio getObject() Returns the current form's model object
 *
 * @package    amina
 * @subpackage form
 ...
 */
abstract class BaseProgramaColegioForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('programa_colegio[%s]');
