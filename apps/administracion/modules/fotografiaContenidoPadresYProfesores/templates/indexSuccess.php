...
<h1 style="text-align: center;">Imágenes del contenido</h1>
					...
					<?php foreach($fotografia_contenido_padres_y_profesoress as $fotografia_contenido_padres_y_profesores): ?>
						<div class="caja-imagen" style="">
                                                    <div onclick="javascript:eliminarImagen('<?php echo url_for('fotografiaContenidoPadresYProfesores/delete?id='.$fotografia_contenido_padres_y_profesores->id) ?>',<?php echo $fotografia_contenido_padres_y_profesores->id ?>)"
								...
								<span
									style="padding-top: 3px; padding-left: 5px; display: block; float: right;">Eliminar</span>
                                                     ...
                                                     <!--<div onclick="javascript:editarImagen('<?php // echo url_for('fotografiaContenidoPadresYProfesores/edit?id='.$fotografia_contenido_padres_y_profesores->id) ?>',<?php // echo $fotografia_contenido_padres_y_profesores->id ?>)"
							...
							<?php echo image_tag('/uploads/'.$fotografia_contenido_padres_y_profesores->getFotografia(),array('width' => '200', 'id'=> $fotografia_contenido_padres_y_profesores->id,'class'=>'imagenPiso')); ?>
						</div>
						<?php endforeach ?>
					</div>
...
<div style="text-align: right;">
    <a href="<?php echo url_for('contenidoPadresYProfesores/show?id='.$idContenidoPadresYProfesores) ?>"><button style="font-size: 18px;">Finalizar y visualizar</button></a>
</div>
<br></br>
