...
<h1 style="text-align: center;">Imágenes del programa de colegio</h1>
					...
					<?php foreach($fotografia_programa_colegios as $fotografia_programa_colegio): ?>
						<div class="caja-imagen" style="">
                                                    <div onclick="javascript:eliminarImagen('<?php echo url_for('fotografiaProgramaColegio/delete?id='.$fotografia_programa_colegio->id) ?>',<?php echo $fotografia_programa_colegio->id ?>)"
								...
								<span
									style="padding-top: 3px; padding-left: 5px; display: block; float: right;">Eliminar</span>
                                                     ...
                                                     <!--<div onclick="javascript:editarImagen('<?php // echo url_for('fotografiaProgramaColegio/edit?id='.$fotografia_programa_colegio->id) ?>',<?php // echo $fotografia_programa_colegio->id ?>)"
							...
							<?php echo image_tag('/uploads/'.$fotografia_programa_colegio->getFotografia(),array('width' => '200', 'id'=> $fotografia_programa_colegio->id,'class'=>'imagenPiso')); ?>
						</div>
						<?php endforeach ?>
					</div>
...
<?php endif; ?>
  <table>
    ...
    <tbody>
      ...
      <tr>
        <th><?php $form['idProgramaColegio']->renderLabel() ?></th>
        <td>
...
<div style="text-align: right;">
    <a href="<?php echo url_for('programaColegio/show?id='.$idProgramaColegio) ?>"><button style="font-size: 18px;">Finalizar y visualizar</button></a>
</div>
<br></br>
