 ...
 */
class VideoCapituloForm2 extends BaseVideoCapituloForm
{
  public function configure()
  {
      ...
      $this->setValidator('idCapitulo', new sfValidatorInteger());  
        ...
        $tipo = Doctrine::getTable('Capitulo')->getLista();
        $tipo[null]='--Seleccione la el capitulo--';
        asort($tipo);
        $this->setWidget('idCapitulo', new sfWidgetFormSelect(array('choices' => $tipo)));
