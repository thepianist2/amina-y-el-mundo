...
/**
 * UnidadTematica form base class.
 *
 * @method UnidadTematica getObject() Returns the current form's model object
 *
 * @package    amina
 * @subpackage form
 ...
 */
abstract class BaseUnidadTematicaForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('unidad_tematica[%s]');
