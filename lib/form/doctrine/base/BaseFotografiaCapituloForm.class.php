...
/**
 * FotografiaCapitulo form base class.
 *
 * @method FotografiaCapitulo getObject() Returns the current form's model object
 *
 * @package    amina
 * @subpackage form
 ...
 */
abstract class BaseFotografiaCapituloForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('fotografia_capitulo[%s]');
