...
/**
 * FotografiaContenidoPadresYProfesores form base class.
 *
 * @method FotografiaContenidoPadresYProfesores getObject() Returns the current form's model object
 *
 * @package    amina
 * @subpackage form
 ...
 */
abstract class BaseFotografiaContenidoPadresYProfesoresForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('fotografia_contenido_padres_y_profesores[%s]');
  ...
  {
    return 'FotografiaContenidoPadresYProfesores';
  }
