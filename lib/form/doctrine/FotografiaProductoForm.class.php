 ...
 */
class FotografiaProductoForm extends BaseFotografiaProductoForm
{
  public function configure()
  {
      ...
      $this->setWidget('idProducto', new sfWidgetFormInputHidden());   
      $this->setValidator('idProducto', new sfValidatorInteger());   
...
$this->validatorSchema['idProducto']->setMessages(array('required' => 'Campo Obligatorio.','invalid' => 'Campo inválido'));
  }
}
