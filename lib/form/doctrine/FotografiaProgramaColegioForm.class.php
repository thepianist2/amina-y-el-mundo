...
/**
 * FotografiaProgramaColegio form.
 *
 * @package    amina
 * @subpackage form
 ...
 */
class FotografiaProgramaColegioForm extends BaseFotografiaProgramaColegioForm
{
  public function configure()
  {
      ...
      $this->setWidget('idProgramaColegio', new sfWidgetFormInputHidden());   
      $this->setValidator('idProgramaColegio', new sfValidatorInteger());   
...
$this->validatorSchema['idProgramaColegio']->setMessages(array('required' => 'Campo Obligatorio.','invalid' => 'Campo inválido'));
  }
}
