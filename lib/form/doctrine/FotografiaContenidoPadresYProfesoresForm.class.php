...
/**
 * FotografiaContenidoPadresYProfesores form.
 *
 * @package    amina
 * @subpackage form
 ...
 */
class FotografiaContenidoPadresYProfesoresForm extends BaseFotografiaContenidoPadresYProfesoresForm
{
  public function configure()
  {
      ...
      $this->setWidget('idContenidoPadresYProfesores', new sfWidgetFormInputHidden());   
      $this->setValidator('idContenidoPadresYProfesores', new sfValidatorInteger());   
...
$this->validatorSchema['idContenidoPadresYProfesores']->setMessages(array('required' => 'Campo Obligatorio.','invalid' => 'Campo inválido'));
