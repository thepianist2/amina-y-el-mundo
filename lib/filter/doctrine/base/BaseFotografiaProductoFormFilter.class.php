...
/**
 * FotografiaProducto filter form base class.
 *
 * @package    amina
 * @subpackage filter
 ...
 */
abstract class BaseFotografiaProductoFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      'idProducto'        => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('Producto'), 'add_empty' => true)),
    ...
    $this->setValidators(array(
      'idProducto'        => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('Producto'), 'column' => 'id')),
    ...
    $this->widgetSchema->setNameFormat('fotografia_producto_filters[%s]');
