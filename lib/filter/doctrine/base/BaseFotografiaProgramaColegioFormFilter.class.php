...
/**
 * FotografiaProgramaColegio filter form base class.
 *
 * @package    amina
 * @subpackage filter
 ...
 */
abstract class BaseFotografiaProgramaColegioFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      'idProgramaColegio' => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('ProgramaColegio'), 'add_empty' => true)),
    ...
    $this->setValidators(array(
      'idProgramaColegio' => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('ProgramaColegio'), 'column' => 'id')),
    ...
    $this->widgetSchema->setNameFormat('fotografia_programa_colegio_filters[%s]');
