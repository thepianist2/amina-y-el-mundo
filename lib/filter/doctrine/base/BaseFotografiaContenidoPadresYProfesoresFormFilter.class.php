...
/**
 * FotografiaContenidoPadresYProfesores filter form base class.
 *
 * @package    amina
 * @subpackage filter
 ...
 */
abstract class BaseFotografiaContenidoPadresYProfesoresFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('fotografia_contenido_padres_y_profesores_filters[%s]');
