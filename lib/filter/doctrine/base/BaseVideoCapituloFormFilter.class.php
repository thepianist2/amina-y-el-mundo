...
/**
 * VideoCapitulo filter form base class.
 *
 * @package    amina
 * @subpackage filter
 ...
 */
abstract class BaseVideoCapituloFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('video_capitulo_filters[%s]');
