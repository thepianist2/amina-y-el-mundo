 ...
 * @property Doctrine_Collection $UnidadTematica
 * 
 ...
 * @method boolean               getEsPremium()             Returns the current record's "esPremium" value
 ...
 * @method Doctrine_Collection   getUnidadTematica()        Returns the current record's "UnidadTematica" collection
 ...
 * @method sfGuardUser           setEsPremium()             Sets the current record's "esPremium" value
 * @method sfGuardUser           setIsActive()              Sets the current record's "is_active" value
 * @method sfGuardUser           setBorrado()               Sets the current record's "borrado" value
 * @method sfGuardUser           setIsSuperAdmin()          Sets the current record's "is_super_admin" value
 * @method sfGuardUser           setLastLogin()             Sets the current record's "last_login" value
 * @method sfGuardUser           setComentario()            Sets the current record's "Comentario" collection
 ...
 * @method sfGuardUser           setUnidadTematica()        Sets the current record's "UnidadTematica" collection
 * 
 * @package    amina
 * @subpackage model
...
abstract class BasesfGuardUser extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        ...
        $this->hasColumn('esPremium', 'boolean', null, array(
             'type' => 'boolean',
             'default' => 0,
             ));
    ...
    public function setUp()
    {
        ...
        $this->hasMany('UnidadTematica', array(
             'local' => 'id',
             'foreign' => 'idUsuario'));
